...
class Beneficiary(pyDatalog.Mixin):
  def __init__(self,
    ...
    self.diagnoses = []
    self.longterm_medicaid = longterm_medicaid
...
def load_diagnostic_category_facts():
  diagnostic_categories = [
          ...
          ("sepsis",["2"]),
          ("substanceabuse",["54","55","56"]),
          ("psychiatric", ["57","58","59"]),
...
agesexva = [ "F65_69",
  "F70_74", "F75_79", "F80_84", "F85_89", "F90_94", "F95_GT", "M65_69",
  "M70_74", "M75_79", "M80_84", "M85_89", "M90_94", "M95_GT"]
agesexvad = ["F0_34","F35_44", "F45_54", "F55_59", "F60_64","M0_34"
  ,"M35_44", "M45_54", "M55_59", "M60_64"]

hccs = ["HCC1","HCC2","HCC6","HCC8","HCC9","HCC10", "HCC11", "HCC12", 
...
def community_aged_regression():
  # &COMM_REG
  reg_vars = agesexva + hccs + ["SEPSIS_CARD_RESP_FAIL",
              "CANCER_IMMUNE",
              "DIABETES_CHF",
              "CHF_COPD",
              "CHF_RENAL",
...
def community_disabled_regression():
  # &COMM_REG
  reg_vars = agesexvad + hccs + ["SEPSIS_CARD_RESP_FAIL",
              "CANCER_IMMUNE",
              "DIABETES_CHF",
              "CHF_COPD",
              "CHF_RENAL",
...
def load_rules():
  ...
  arrthmia_chf(CC,CC2) <= dc("arrthmia", CC) & dc("chf", CC2)
  substanceabuse_psychiatric <= dc("substanceabuse", CC) & dc("psychiatric", CC2)
